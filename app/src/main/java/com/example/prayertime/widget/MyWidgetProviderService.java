...
public class MyWidgetProviderService extends Service {
    ...
    private void setActualPrayerTextColor(RemoteViews remoteViews , int nextPrayercode){
        ...
        remoteViews.setInt(R.id.shorouk_label, "setTextColor", Color.WHITE);
        remoteViews.setInt(R.id.shoroukTime, "setTextColor", Color.WHITE);
        ...
        if(AthanService.isFajrForNextDay == false || AthanService.ifActualSalatTime == true)
        {
            switch (nextPrayercode) {
                ...
                case 1021:
                    remoteViews.setInt(R.id.shorouk_label, "setTextColor", Color.BLACK);
                    remoteViews.setInt(R.id.shoroukTime, "setTextColor", Color.BLACK);
